  ...
  constructor: ->
    ...
    @events = {
      'rise-conference-2015':
        ...
        booth: 'Comming soon'
        special: ''
        site: {url: 'http://riseconf.com/', name: 'Rise Conference Hong Kong'}
      ,
      'streaming-media-east-2015-new-york':
        ...
        site: {url: 'http://www.streamingmedia.com/Conferences/East2015/', name: 'STREAMING MEDIA EAST 2015 NEW YORK'}
      ,
      'collision-conference-las-vegas-\'15':
        ...
        site: {url: 'http://collisionconf.com/', name: 'Collision'}
      ,
      'tnw-europe-conference-amsterdam-2014':
        ...
        booth: 'Coming Soon'
        special: 'Own booth on day 1'
        site: {url: 'http://thenextweb.com/conference/europe/', name: 'TheNextWeb'}
      ,
      'wolves-summit-startup-messe-\'15':
        ...
        booth: 'Coming Soon'
        special: 'Coming Soon'
        site: {url: 'http://wolvessummit.com/', name: 'Wolves Summit'}
      ,
      'it-and-media-future-congress-\'15':
        ...
        booth: 'Coming Soon'
        special: 'Coming Soon'
        site: {url: 'http://www.itandmedia.de/messe-darmstadt.html', name: 'IT & Media'}
      ,
      'ces-las-vegas \'15':
      ...
      'tnw-conference-nw-2014':
        ...
        booth: 'Coming Soon'
        special: 'Coming Soon'
        site: {url: 'http://thenextweb.com/conference/usa/', name: 'TheNextWeb'}
      ,
      'web-summit-2014':
        ...
        booth: 'Coming Soon'
        special: 'Beta Deck'
        site: {url: 'http://websummit.net/', name: 'Web Summit'}
      ,
      'pioneers-festival-2014':
        ...
        site: {url: 'http://pioneers.io/festival', name: 'Pioneers Festival'}
      ,
      'cebit-istanbul-14':
        ...
        site: {url: 'http://www.cebitbilisim.com/', name: 'CeBIT Bilişim Eurasia'}
      ,
